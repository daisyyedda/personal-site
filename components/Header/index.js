            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  ...
                  {showResume && (
                    <Button
                      onClick={() => window.open("https://pdfhost.io/v/.j30X6vmNI_Daisy_Ye_Resume_2024")}
                    >
                      Resume
                    </Button>
                  )}
                  ...
                  <Button
                    onClick={() => window.open("mailto:c42ye@uwaterloo.ca")}
                  >
                    Contact
                  </Button>
                </div>
                ...
                <div className="grid grid-cols-1">
                  ...
                  <Button
                    onClick={() => window.open("mailto:c42ye@uwateloo.ca")}
                  >
                    Contact
                  </Button>
                </div>
      ...
      >
        ...
        {!isBlog ? (
          ...
          <div className="flex">
            ...
            <Button onClick={() =>
                        window.open("mailto:c42ye@uwaterloo.ca")
                      }>
              Contact
            </Button>
